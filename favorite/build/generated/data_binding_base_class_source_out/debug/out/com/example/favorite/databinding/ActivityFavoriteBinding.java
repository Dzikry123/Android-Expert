...
public final class ActivityFavoriteBinding implements ViewBinding {
  ...
  private ActivityFavoriteBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView FavoriteListRv) {
    this.rootView = rootView;
    this.FavoriteListRv = FavoriteListRv;
  }
  ...
  public static ActivityFavoriteBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.FavoriteListRv;
      RecyclerView FavoriteListRv = ViewBindings.findChildViewById(rootView, id);
      if (FavoriteListRv == null) {
        break missingId;
      }

      return new ActivityFavoriteBinding((ConstraintLayout) rootView, FavoriteListRv);
    }
